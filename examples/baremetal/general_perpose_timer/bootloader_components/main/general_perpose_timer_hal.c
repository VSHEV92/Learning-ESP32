...
void __attribute__((noreturn)) call_start_cpu0(void)
{
    ...
    // 2. Init hal structure and disable all timer settings
    timer_hal_init(&timer_hal, TIMER_GROUP, TIMER_NUMBER_IN_GROUP);
    timer_dev = timer_hal.dev;
    ...
    timer_hal_set_counter_value(&timer_hal, 0);
